      ...
      <div className="md:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div className="p-6 space-y-4">
              ...
              <p className="text-lg text-gray-800 font-medium">
                By {featuredArticle.author ? `${featuredArticle.author.firstName} ${featuredArticle.author.lastName}` : "Expert Team"}
              </p>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {remainingArticles.map((article) => (
            <div key={article._id} className="bg-white rounded-xl shadow-md border border-gray-50 overflow-hidden flex flex-col">
          ...
          <ul className="space-y-1 text-sm text-gray-700 font-medium">
            {CATEGORIES.map((cat) => (
              <li
                ...
                className={`
                  cursor-pointer py-2 rounded-lg px-3 transition-all
                  ${
                    activeCategory === cat
