...
const CATEGORIES = ["All", "NFL", "NBA", "MLB", "NHL", "Soccer", "Tennis", "UFC", "Other"];
...
export default function Article() {
  ...
  if (isLoading && page === 1) return <div className="text-center p-20">Loading articles...</div>;

  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4 mt-20">
      <div className="md:col-span-2 space-y-8">
        <h2 className="text-4xl font-semibold">
          {activeCategory === "All" ? "Featured Articles" : `${activeCategory} Articles`}
        </h2>
        ...
        {featuredArticle && (
          <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            <div className="relative w-full h-80 bg-gray-100">
              {featuredImage ? (
                <Image src={featuredImage} alt={featuredArticle.title} fill className="object-cover" />
              ) : (
            ...
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-3 text-xs text-gray-500">
                <span className="bg-[#B91C1C] text-white px-3 py-1 rounded">{featuredArticle.category}</span>
              ...
              <p className="text-gray-600 text-base line-clamp-3">{stripHtml(featuredArticle.content)}</p>
            ...
            return (
              ...
              >
                <div className="relative w-full h-52 bg-gray-100">
                  {safeImageSrc ? (
                    <Image src={safeImageSrc} alt={article.title} fill className="object-cover" />
                  ) : (
                ...
                <div className="p-4 flex flex-col flex-grow space-y-3">
                  ...
                  <p className="text-sm text-gray-600 line-clamp-2 flex-grow">{stripHtml(article.content)}</p>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#1a1a1a] p-6 shadow-lg rounded-xl text-white">
          ...
          <p className="text-sm text-gray-400 mb-4">
            Get the latest sports analysis and winning picks delivered to your inbox.
          </p>
    ...
    <div className="bg-white p-6 shadow-lg rounded-xl border border-gray-50">
      ...
      <div className="flex flex-col gap-4">
        {data.data.map((article) => {
          ...
          return (
            <Link key={article._id} href={`/blog/${article.slug}`} className="flex items-start gap-3 group">
              ...
              <div className="text-xs space-y-1">
                ...
                <p className="text-gray-400 font-medium">{new Date(article.createdAt).toLocaleDateString()}</p>
              </div>
            </Link>
          );
        })}
