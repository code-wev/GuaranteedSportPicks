          ...
          <form onSubmit={handleSubmit} className='p-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 mt-5'>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className='w-full  rounded-lg border border-[#D4D4D4] bg-[#F5F5F5] px-3 py-3 text-sm text-gray-700 focus:outline-none focus:ring-1 focus:ring-red-400'>
            ...
            <div className='mt-5'>
              ...
              <textarea
                ...
                maxLength={500}
                className='w-full h-32 rounded-md border border-[#D4D4D4] bg-[#F5F5F5] px-3 py-3 text-sm resize-none focus:outline-none focus:ring-1 focus:ring-red-400'></textarea>
            ...
            <button
              type='submit'
              className='w-full bg-[#B91C1C] hover:bg-[#B02020] transition text-white mt-6 py-3 rounded-md font-medium'>
              Send Message
            </button>
          </form>
        </div>
