      ...
      <div className='relative mx-auto max-w-[1440px] px-4 sm:px-6 h-[720px] lg:h-[820px]'>
        ...
        <div className='pt-[70px] lg:pt-[95px] text-center'>
          ...
          <button
            ...
            className='mt-[22px] lg:mt-[26px] inline-flex items-center gap-[8px] bg-[#DC2626] hover:bg-[#B91C1C] text-white px-[26px] lg:px-[30px] py-[11px] lg:py-[12px] rounded-full text-[13px] lg:text-[14px] font-semibold transition'>
