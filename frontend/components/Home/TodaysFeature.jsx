...
import { FaCheck, FaFireAlt, FaLock, FaTrophy, FaWind } from "react-icons/fa";
      ...
      <div className='bg-white/14 backdrop-blur-md rounded-2xl shadow-2xl max-w-4xl w-full'>
        ...
        <div className='flex flex-col items-center mb-10'>
          <button
            ...
            className='bg-[#E53935] hover:from-red-500 hover:to-orange-400 text-white font-semibold px-6 py-3 rounded-full flex items-center gap-2 shadow-lg transition'>
