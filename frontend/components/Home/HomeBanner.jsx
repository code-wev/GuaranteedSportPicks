      ...
      <div className='relative z-10 max-w-[1280px] mx-auto px-6 py-24 min-h-[80vh]'>
        ...
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-8'>
          ...
          <div className='flex flex-wrap items-center gap-4 mb-10'>
            <button
              onClick={() => router.push("/freepicks")}
              className='flex items-center gap-2 bg-[#E53935] text-white hover:bg-[#d53240] px-8 py-3 rounded-full font-semibold text-sm transition'>
            ...
            <button
              ...
              className='flex items-center gap-2 border border-[#E53935] px-8 py-3 rounded-full font-semibold text-sm text-[#FFCDD2] hover:bg-white/10 transition'>
              <span className='w-2.5 h-2.5 bg-[#FFCDD2] rounded-full' />
              See Packages
            </button>
          </div>
