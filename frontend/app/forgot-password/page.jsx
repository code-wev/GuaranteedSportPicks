      ...
      <div className='w-full max-w-md bg-white shadow-xl rounded-3xl p-10 border border-gray-100'>
        ...
        {status === "success" && (
          <div className="py-10 text-center animate-in fade-in zoom-in duration-300">
            ...
            <div className="mt-8">
                <Link href='/login' className='inline-flex items-center gap-2 text-sm font-bold text-[#B91C1C] hover:text-[#991B1B] transition-colors'>
        ...
        {status === "form" && (
          <>
            ...
            <div className="mt-8 pt-8 border-t border-gray-100 text-center">
                <Link href='/login' className='inline-flex items-center gap-2 text-sm font-bold text-gray-500 hover:text-[#B91C1C] transition-colors'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                    </svg>
                    Back to login
