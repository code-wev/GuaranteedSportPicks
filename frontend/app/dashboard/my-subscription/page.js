...
import { useGetMySubscriptionQuery, useCancelSubscriptionMutation } from "@/feature/PaymentApi";
...
export default function MySubscriptionPage() {
  ...
  return (
    <div className="w-full px-4 md:px-8 py-6 max-w-3xl mx-auto">
      ...
      <p className="text-gray-500 mb-8">Manage your current subscription plan</p>
      ...
      {(!sub || isError) ? (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">
            You don't have any subscription yet. Browse our plans and get started today.
          </p>
          <Link
            href="/packages"
        ...
        <>
            ...
            <div className="flex items-start justify-between mb-5">
              <div>
                <h3 className="text-xl font-bold text-gray-800 capitalize">
                  {sub.packageName?.charAt(0) + sub.packageName?.slice(1).toLowerCase()} Plan
                  {sub.isSession && ` (${sub.customDays} days)`}
                </h3>
                <p className="text-sm text-gray-500 mt-1">
                  {sub.isSession ? "One-time sessional payment" : "Recurring subscription"}
                </p>
              </div>
          ...
          {isActive && (
            <div className="bg-white rounded-2xl shadow-sm border border-red-100 p-6">
              <h4 className="font-semibold text-gray-800 mb-1">Cancel Subscription</h4>
