...
export default function ProfileSettings() {
  ...
  const [toggleNewsletter, { isLoading: togglingNewsletter }] =
    useToggleNewsletterMutation();
  ...
  const handleNewsletterToggle = async () => {
    try {
      ...
      toast.success(
        `Newsletter ${newStatus ? "enabled" : "disabled"} successfully!`,
      );
      refetchNewsletter();
    } catch (error) {
  ...
  const deletePhraseMatches =
    formData.deletePhrase.trim() === "DELETE MY ACCOUNT";
  const deleteEmailMatches =
    formData.deleteEmail.trim().toLowerCase() ===
          ...
          <div className='mb-10 p-4 bg-gray-50 rounded-lg border border-gray-200'>
            <div className='flex items-center justify-between'>
              ...
              <button
                ...
                <span
                  className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${newsletterEnabled ? "translate-x-6" : "translate-x-1"}`}
                />
              </button>
            </div>
          </div>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div>
                    ...
                    <p className='mt-1 text-sm text-red-900/80'>
                      Account deletion is permanently destructive. We require
                      multiple confirmations before this can be submitted.
                    </p>
                  </div>
                </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-3'>
                <div className='rounded-xl border border-red-200 bg-white/80 p-4'>
                  ...
                  <p className='mt-2 text-sm text-slate-700'>
                    Current password is required before any delete request is
                    accepted.
                  </p>
                </div>
                <div className='rounded-xl border border-red-200 bg-white/80 p-4'>
                  ...
                  <p className='mt-2 text-sm text-slate-700'>
                    Exact account email and the phrase DELETE MY ACCOUNT must
                    match exactly.
                  </p>
                </div>
                <div className='rounded-xl border border-red-200 bg-white/80 p-4'>
                  ...
                  <p className='mt-2 text-sm text-slate-700'>
                    Backend blocks deletion if a subscription or payment is
              ...
              {deleteConfirmVisible && (
                <form
                  ...
                  className='rounded-2xl border border-red-300 bg-white p-5'>
                  <div className='flex items-center gap-2 mb-4 text-red-800'>
                    <FiLock className='w-4 h-4' />
                    <p className='text-sm font-medium'>
                      Secure account deletion verification
                    </p>
                  </div>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("deleteEmail", e.target.value)
                        }
                        className='w-full h-11 px-3 rounded-md border border-red-200 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-500 transition'
                        placeholder={profile?.email || "your@email.com"}
                      />
                      <p
                        className={`mt-1 text-xs ${formData.deleteEmail ? (deleteEmailMatches ? "text-emerald-700" : "text-red-700") : "text-gray-500"}`}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleInputChange("deletePhrase", e.target.value)
                        }
                      ...
                      />
                      <p
                        className={`mt-1 text-xs ${formData.deletePhrase ? (deletePhraseMatches ? "text-emerald-700" : "text-red-700") : "text-gray-500"}`}>
                    ...
                    <label className='flex items-start gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-3'>
                      ...
                      <span className='text-sm text-red-900'>
                        I understand this action is permanent, cannot be undone,
                        and may be blocked until all active billing or in-flight
                  ...
                  <div className='mt-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3'>
                    <p className='text-xs text-gray-500'>
                      For security, the server will verify all confirmation
                      fields again before deleting the account.
                    </p>
                    <button
                      type='submit'
