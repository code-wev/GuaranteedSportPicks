    ...
    <section className="relative w-full bg-white bg-cover bg-center bg-no-repeat py-16 md:py-20 overflow-hidden"
      ...
      <div className="max-w-[1100px] mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-7">
          ...
          <div className="translate-y-6 md:translate-y-8 transition-all duration-300">
            <ArticleCard
          ...
          {/* Card 3 - more lower */}
          <div className="translate-y-12 md:translate-y-14 transition-all duration-300">
            <ArticleCard
  ...
  return (
    <article className="group rounded-[18px] bg-white border border-[#00000012] shadow-[0_14px_36px_rgba(0,0,0,0.08)] overflow-hidden">
      ...
      <div className="px-4 pt-4 pb-4">
        ...
        <a
          className="mt-3 inline-block text-[13px] font-semibold text-[#E63946] hover:underline"
          href="#"
        >
          Read Full Article &gt;
        </a>
